# Bulletin: 実験一覧の行を右クリックしてメニューを表示する
...
- [`pContextMenuRow`](./src/app/webapp-common/shared/ui-components/data/table/table.component.html#L124)
...
- [`MatMenuTrigger.openMenu()`](./src/app/webapp-common/shared/components/base-context-menu/base-context-menu.component.ts#L54)
...
メニュー項目をクリックした後の処理は、このBulletinの対象外とする。
