...
export const getAppConfig = (
  ...
  return {
    providers: [
      ...
      // withInterceptorsFromDi() が無いと HTTP_INTERCEPTORS は読まれない。
      // Angular 22 の HttpClient は providedIn:'root' なので、外すと通信は動いたまま
      // WebappInterceptor だけが黙って無効になる。詳細は apps/web/README.md。
