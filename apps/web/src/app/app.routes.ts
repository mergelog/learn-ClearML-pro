...
export const routes: Routes = [
  {
    ...
    children: [
      ...
      {
        path: 'quality-pipeline',
        loadChildren: () =>
          import('./features/quality-pipeline/quality-pipeline.routes').then(r => r.routes),
        data: {search: false},
      },
      {
        path: 'data-catalog',
        loadChildren: () =>
          import('./features/data-catalog/data-catalog.routes').then(r => r.routes),
        data: {search: false},
      },
      {
        path: 'settings',
