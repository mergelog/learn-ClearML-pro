...
@Component({
  ...
  templateUrl: '../../../../../../src/app/webapp-common/models/containers/model-menu/model-menu.component.html',
  styleUrls: ['../../../../../../src/app/webapp-common/models/containers/model-menu/model-menu.component.scss'],
  imports: [
    TagsMenuComponent,
    MatIconModule,
    MatIconButton,
