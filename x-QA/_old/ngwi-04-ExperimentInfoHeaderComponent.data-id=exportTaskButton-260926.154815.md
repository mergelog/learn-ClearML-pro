...
- div.experiment-body
- as-split.as-horizontal.as-percent
- as-split-area.as-split-area:nth-child\(2\)
- sm-experiment-output
- div.experiment-output-container.light-theme
- sm-experiment-info-header
- div.d-flex.align-items-center:nth-child\(1\)
- div.d-flex.align-items-center:nth-child\(2\)
- button.line-item.\_mat-animation-noopable:nth-child\(4\)

## exec command

npx github:mergelog/ng-wiring 'data-id=exportTaskButton' --selector 'body > sm-root > sm-app-shell > div.root-container > div.app-container > sm-common-experiments > div.experiment-body > as-split.as-horizontal.as-percent > as-split-area.as-split-area:nth-child(2) > sm-experiment-output > div.experiment-output-container.light-theme > sm-experiment-info-header > div.d-flex.align-items-center:nth-child(1) > div.d-flex.align-items-center:nth-child(2) > button.line-item._mat-animation-noopable:nth-child(4)' --candidate 'cand:02a7a97efd772411cff7658af012857892aa721fdd97c74cdcff9ff801897a3f'
